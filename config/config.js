...
config.general = {
  ...
  serverToken: 'fnasdjkf&fhjlk21b312mnbdsanm,fb',
  // The welcome message seen by TCP and webSocket clients upon connection
  welcomeMessage: 'Hello! Welcome to the Delta Hosting API',
